...
public class GooglePO extends BasePO {
	...
	public WebElement divResultadoCadastro;
...
//		return divResultadoPesquisa.getText();
	...
	public String obterResultadoDoCadastro() {
//		return divResultadoPesquisa.getText();
		return divCads.getText();
	}
	
	public void cadastrar(String texto) {
		inputCadastro.sendKeys(texto + Keys.ENTER);
	}
