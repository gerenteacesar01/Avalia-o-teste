...
//		String resultado = googlePage.divPesq.getText();
	...
	@Test
	public void TC001_naoDeveSerPossivelCadstrarUmProdutoSoComOCodigo() {
		googlePage.inputCadastro.sendKeys("Caixas" + Keys.ENTER);
		
		String resultado = googlePage.divCads.getText();
	...
	@Test
	public void TC002_naoDeveSerPossivelCadstrarUmProdutoSoComONome() {
		googlePage.inputCadastro.sendKeys("Caixas" + Keys.ENTER);
	...
	@Test
	public void TC003_deveSerPossivelExcluirUmProduo() {
		googlePage.inputCadastro.sendKeys("Caixas" + Keys.ENTER);
	...
	@Test
	public void TC004_deveSerPossivelEditarUmProduo() {
		googlePage.inputCadastro.sendKeys("Caixas" + Keys.ENTER);
	...
	@Test
	public void TC005_deveSerPossivelSairDoModalQuandoClicarNoBotaoDeSair() {
		googlePage.inputCadastro.sendKeys("Caixas" + Keys.ENTER);
